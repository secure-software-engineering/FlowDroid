...
/**
 * Common interface for all callback filters. A callback filter takes the discovered
 * associations between host components and callbacks and filters out those that are
 * not of interest to the analysis.
 * 
 * @author Steven Arzt
 *
 */
public interface ICallbackFilter {
	 ...
	 * component
	 * @param component The component at whose runtime the callback is to be invoked
	 * @param callbackHandler The class containing the callback implementation
	 * @return True if the filter accepts the callback to be registered, otherwise false
	 */
