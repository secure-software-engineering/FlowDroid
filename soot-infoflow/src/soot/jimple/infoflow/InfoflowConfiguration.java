...
public class InfoflowConfiguration {
    ...
    public static class PathConfiguration {
         ...
         * Another var `pathReconstructionTimeout` is the limited time for reconstructing
         * each batch or path. If `pathReconstructionTotalTime` is set as a negative value
         * or 0, it implies ignoring the time restriction.
         *
         ...
         * or 0, it implies ignoring the time restriction.
         *
         * @param pathReconstructionTotalTime The total time to set for the path reconstruction in seconds
         */
