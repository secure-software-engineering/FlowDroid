 ...
 * Note that in Secondary Flows the "source" is the sink of the primary flow and
 * the "sinks" are the statements reached in between
 * 
 * @author Tim Lange
 */
public interface IAdditionalFlowSinkPropagationRule {
	 ...
	 * @param stmt   The current statement, which is assumed to be a sink
	 */
	void processTurnAroundSink(Abstraction d1, Abstraction source, Stmt stmt);
}
