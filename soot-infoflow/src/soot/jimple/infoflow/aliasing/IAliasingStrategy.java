...
public interface IAliasingStrategy {
	...
	/**
	 * Gets whether this aliasing strategy is interactive, i.e. computes aliases on
	 * demand.
	 * 
	...
	/**
	 * Notifies the aliasing strategy that a method has been called in the taint
	 * analysis. This may be helpful for interprocedural alias analyses.
	 * 
	 ...
	 */
	public void injectCallingContext(AbstractDataFlowAbstraction abs, IInfoflowSolver fSolver, SootMethod callee,
	...
	/**
	 * Gets whether this algorithm requires the analysis to be triggered again when
	 * returning from a callee.
	 * 
	...
	/**
	 * Gets whether this analysis is lazy, i.e., needs all taints to be propagated
	 * into all methods, even if the respective access path is not even visible
	 * inside the callee (but an alias may be visible).
	 * 
	 * @return True if the alias analysis requires all taints to be propagated into
	 *         all methods
	 */
	public boolean isLazyAnalysis();

	/**
	 * If this aliasing strategy uses an additional IFDS solver, it is returned by
	 * this method. If this IFDS problem does not have a an additional solver, null
	 * is returned.
	 * 
