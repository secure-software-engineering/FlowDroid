...
public interface ITaintPropagationWrapper {
	...
	/**
	 * Checks whether t2 is a subtype of t1 based on summaries. Does NOT query
	 * the hierarchy generated by Soot.
	 *
	 * @param t1 The type
	 * @param t2 The potential subtype
	 * @return True if t2 is a subtype t1
	 */
