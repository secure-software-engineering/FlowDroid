...
public class RiverTests {
    ...
    protected static final String localSource = "<soot.jimple.infoflow.test.river.RiverTestCode: java.lang.String source()>";
    ...
    protected IInfoflow initInfoflow() {
        AbstractInfoflow result = new Infoflow("", false, null);
    ...
    public void riverTest1() {
        ...
        epoints.add("<soot.jimple.infoflow.test.river.RiverTestCode: void riverTest1()>");
        infoflow.computeInfoflow(appPath, libPath, epoints, sources, primarySinks);
    ...
    public void riverTest2() {
        IInfoflow infoflow = this.initInfoflow();
        List<String> epoints = new ArrayList();
        epoints.add("<soot.jimple.infoflow.test.river.RiverTestCode: void riverTest2()>");
        infoflow.computeInfoflow(appPath, libPath, epoints, sources, primarySinks);
